 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 115.08 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -10, -3.5 }
...
#define HOMING_FEEDRATE_Z  (3*4*60)  // Multiplier*mm/min; increases negligble innacuracy by 33%,
